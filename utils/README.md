...
- `Tables.py` is a script for getting tables from MCMC chains (tested for cobaya). See the notebook `example_tables.ipynb` in the folder for a self-explanatory example.
